...
void CAN1_RX0_IRQHandler(void)
{
	...
	for(int LEN=0;LEN<=7;LEN++)//读下来一帧数据
	Can1Msg.data8[LEN]=buffer[LEN];
	changedata++;
	if(StdId==0x0281)
	{
		if( Can1Msg.data32[0]==0x00005850)
		readmotor.pos=Can1Msg.data32[1];
		if( Can1Msg.data32[0]==0x00005856)
		readmotor.vel=Can1Msg.data32[1];
	}
